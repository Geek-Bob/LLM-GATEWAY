...
# 共享资源清单
- 组件：Button、Card、Input、Textarea、Select、Dialog、AlertDialog、Table、Badge、StatusBadge、Switch、Checkbox、Label、PageHeader、EmptyState、TableSkeleton、Skeleton、Pagination、Popover、ScrollArea、Separator、Progress、CodeEditor、Markdown
