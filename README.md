...
<tr><td>Thinking</td><td>reasoning_effort → thinking budget_tokens</td><td>thinking → reasoning_effort</td></tr>
...
# 运行 converter 测试
npx vitest run src/main/proxy/__tests__/converter.test.ts  # 67 tests
